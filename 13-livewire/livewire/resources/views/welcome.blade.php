        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center" style="align-items: center">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 15px" class="h-16 w-auto bg-gray-100 dark:bg-gray-900">
                    ...
                    <center><h1 style="color: white; font-size: 60px">container: {{ gethostname() }}</h1></center>
                </div>
